    ...
    <tbody>
      <tr>
        <td width="12%" align="center" valign="top" bgcolor="#E1D4BC"><p>&nbsp;</p>
          ...
          <p><a href="urent.php"><font color="#5F3504"> 已借阅书籍</font> </a>  </p>
  ...
  <tr>
    ...
    <td width="11%" align="center">&nbsp;</td>
     ...
     <?php
		  ...
		  $id=$_SESSION["id"];
	 $result=mysql_query("select * from rentbook where id='".$id."' limit ".$startPage*$pageSize.",".$pageSize);
...
?>
    ...
    print "<a href='return.php?bid={$row["bid"]}'><font color='#E70C6F'> 归还</font></a>";	
