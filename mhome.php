    ...
    <tbody>
      <tr>
        <td width="12%" align="center" valign="top" bgcolor="#E1D4BC"><p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="mhome.php"><font color="#5F3504">图书管理 </font> </a>  </p>
          <p><a href="mcheck.php"><font color="#0B0707"> 借阅信息</font> </a>  </p>
...
while($row=mysql_fetch_array($result)){
  ...
  <tr>
	...
	print "<a href='update.php?bid={$row["bid"]}'><font color='#5F3504'>".$row["bname"]."</font></a>";
...
&nbsp;</td>
    ...
    print "<a href='delete.php?bid={$row["bid"]}'><font color='#E70C6F'>下架</font></a>";
...
&nbsp;</td>
  ...
  <?php  
	...
	?>
  <tr>
    <td height="31" colspan="4" align="right"><a href="new.php"><font color="#E70C6F">新书上架</font></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
      <?php
    if($page==0){
	?>
      首页	 &nbsp; 上页
